...
fun SimpleExoPlayer.preparePlayer(tvDes : String, playerView: PlayerView, forceLandscape:Boolean = false) {
    (playerView.context as AppCompatActivity).apply {
        ...
        val btnOpenFullScreen : ImageView = playerView.findViewById(R.id.exo_fullscreen_icon)
        val btnCloseFullScreen : ImageView = playerViewFullscreen.findViewById(R.id.exo_fullscreen_icon)

        val btnPlay : ImageButton = playerView.findViewById(R.id.exo_play)
        val btnPause: ImageButton = playerView.findViewById(R.id.exo_pause)

        val tvDescription : TextView = playerView.findViewById(R.id.tvDes)
        tvDescription.text = tvDes
        ...
        btnOpenFullScreen.setImageDrawable(ContextCompat.getDrawable(this, R.drawable.ic_fullscreen_open))
        btnCloseFullScreen.setImageDrawable(ContextCompat.getDrawable(this, R.drawable.ic_fullscreen_close))
        btnOpenFullScreen.setOnClickListener {
